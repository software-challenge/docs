...
WARNING: Die XML Dokumentation behandelt ausschließlich die Kommunikation. Falls Sie Dokumentation für den Verbindungsaufbau suchen, so finden Sie diese https://cau-kiel-tech-inf.github.io/socha-enduser-docs/_computerspieler_abgabefertig_machen.html#andere-sprache[hier].
