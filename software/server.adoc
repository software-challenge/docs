...
Es ist jedoch möglich, die Testdurchläufe ohne die grafische Oberfläche zu
starten. Dies ist im Abschnitt <<tests-ohne-gui>> beschrieben.
...
|port
|13051
|Der Port auf den der Testserver hört
