...
= Software-Challenge XML-Dokumentation Hive
...
Dokumentation kann
https://github.com/software-challenge/docs[direkt auf
...
https://github.com/software-challenge/docs/blob/master/index.adoc[index.adoc]
