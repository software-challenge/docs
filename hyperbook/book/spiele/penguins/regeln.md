...
:::alert{info}
Auf dem Spielserver werden ``BOARD_SIZE * (BOARD_SIZE + 1)`` aka `8 * 9` viele Fische gleichmäßig auf dem Board verteilt, wobei es auch zu Beginn Felder ohne Fische geben kann.
:::
